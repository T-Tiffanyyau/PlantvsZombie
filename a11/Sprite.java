 ...
 * 
 * This object supports moving around the grid, and can also check whether it's
 * overlapping with other sprites.
 * 
...
public class Sprite {
	 ...
	 *                  this is used both for the display size of this sprite as
	 *                  well as its size for collision detection, unless isColliding
	 *                  is overridden.
	...
	/**
	 * Checks if this sprite is colliding with any sprite in the provided list. This
	 * method will always use isColliding, so implementing custom collision
	 * detecting only requires overriding isColliding.
	 * 
